...
<img width="975" height="220" alt="image" src="https://github.com/user-attachments/assets/1e649831-6bba-437a-b168-05d86d3212b3" />

<b>Observe RDP Traffic</b> 

Finally, filter in Wireshark for:

```powershell
tcp.port == 3389
```

- This captures RDP traffic generated by your active Remote Desktop session.
- Unlike SSH, which only sends data when commands are typed.
- RDP constantly streams graphical data, resulting in continuous traffic even when idle.

<img width="975" height="369" alt="image" src="https://github.com/user-attachments/assets/a059294a-5edc-4769-a784-627684f3e9ec" />
